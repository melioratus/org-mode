...
- Literate Programming[fn:2][fn:4] in over 30 languages. 
- Project, Task and Time Management.
- Data Science 
- Reproducible Research 
- Create and maintain documentation[fn:5] in multiple popular formats including PDF, HTML[fn:6] and Markdown.
- Track and synchronize data across heterogeneous paradigms, technologies and formats including source code, network diagrams, Infrastructure as Code, DevOps[fn:7], databases, servers and services.
...
: ([^\w\S]+)((\b(b(?:bdb|ibtex)|do(?:cview|i)|e(?:lisp|shell|ww)|f(?:ile(?:[+](?:(?:emac|sy)s))?|tp)|gnus|h(?:elp|ttps?)|i(?:d|nfo|rc)|m(?:ailto|he)|news|rmail|shell|w3m):)|[.]?/)([^<>\(\)\s]+((\w|\W\S)+|(?=[^\s,.!?'"\-;&/]/)))(\W)
...
[fn:4] [[http://kitchingroup.cheme.cmu.edu/blog/2014/03/27/Literate-programming-in-python-with-org-mode-and-noweb/][http://kitchingroup.cheme.cmu.edu/blog/2014/03/27/Literate-programming-in-python-with-org-mode-and-noweb/]]

[fn:5] [[https://github.com/fniessen/refcard-org-mode][https://github.com/fniessen/refcard-org-mode]]

[fn:6] [[https://github.com/fniessen/org-html-themes][https://github.com/fniessen/org-html-themes]]

[fn:7] [[http://howardism.org/Technical/Emacs/literate-devops.html][http://howardism.org/Technical/Emacs/literate-devops.html]]

[fn:8] In particular, the parser requires stars at column 0 to be
quoted by a comma when they do not define a headline.

[fn:9] It also means that only headlines and sections can be
...
[fn:10] [[https://orgmode.org/manual/External-links.html]]
