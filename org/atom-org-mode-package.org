...
#+BEGIN_SRC js :cmd "node" :var data="**** other stuff goes here" :results replace output :var pattern=STARS() :wrap "SRC js :eval never"
  var re = new RegExp(pattern);
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="**** DONE stuff goes here" :results replace output :var pattern=(concat (org-sbe STARS) (org-sbe KEYWORD)) :wrap "SRC js :eval never"
  var re = new RegExp(pattern);
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="**** DONE [#A] stuff goes here" :results replace output :var pattern=(concat (org-sbe STARS) (org-sbe KEYWORD) (org-sbe PRIORITY)) :wrap "SRC js :eval never"
  var re = new RegExp(pattern);
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="**** DONE [#A] *this* /is/ _the_ =title= +of+ ~my~ headline :notattag:" :results replace output :var pattern=(concat (org-sbe STARS) (org-sbe KEYWORD) (org-sbe PRIORITY) (org-sbe TITLE)) :wrap "SRC js :eval never"
  var re = new RegExp(pattern);
  console.log(data.match(re))
#+END_SRC
