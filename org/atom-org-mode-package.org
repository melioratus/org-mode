...
#+CALL: gen-grammar-text-markup-cson(text_markers='(("=" "verbatim")), exclude_patterns=grammar-text-markup-include-objects())
...
#+CALL: gen-grammar-text-markup-cson(text_markers='(("~" "code")), exclude_patterns=grammar-text-markup-include-objects())
