...
#+BEGIN_SRC css :noweb yes :noweb yes
      ...
      'patterns':[
          {
            ...
            'captures':
              '0':
                'name': 'markup.underline.link.org-mode'
              '1':
                'name': 'punctuation.definition.regular-link.begin.org-mode'
              '2':
                'name': 'punctuation.definition.regular-link.meta-path3.begin.org-mode'
              '3':
                'name': 'markup.link.protocol.regular-link.org-mode'
              '5':
                'name': 'markup.link.path.regular-link.org-mode'
              '6':
                'name': 'punctuation.definition.regular-link.meta-path3.end.org-mode'
              '7':
                'name': 'meta.regular-link.meta-description.org-mode'
              '8':
                'name': 'punctuation.definition.regular-link.meta-description.begin.org-mode'
              '9':
                'name': 'markup.link.description.regular-link.org-mode'
              '10':
                'name': 'punctuation.definition.regular-link.meta-description.end.org-mode'
              '11':
                'name': 'punctuation.definition.regular-link.end.org-mode'
          }
      ]
  EOT
#+END_SRC
...
#+begin_example
  'object-regular-link':
    'patterns':[
        {
          'match': "([\\[])([\\[])((b(?:bdb|ibtex)|coderef|do(?:cview|i)|e(?:lisp|shell|ww)|f(?:ile(?:[+](?:(?:emac|sy)s))?|tp)|gnus|h(?:elp|ttps?)|i(?:d|nfo|rc)|m(?:ailto|he)|news|rmail|shell|w3m):)?([^\\]]+)([\\]])(([\\[])([^\\]]+)([\\]]))?([\\]])"
          'captures':
            '0':
              'name': 'markup.underline.link.org-mode'
            '1':
