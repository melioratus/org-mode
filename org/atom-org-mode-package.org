...
#+BEGIN_SRC js :cmd "node" :var data="**** other stuff goes here" :results replace output :var pattern="^([*]+) "
  var re = new RegExp(pattern);
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="**** DONE stuff goes here" :results replace output :var pattern="^(?:[*]+) (TODO|DONE)"
  var re = new RegExp(pattern);
  console.log(data.match(re))
#+END_SRC
...
******** TODO Add TITLE begins with =COMMENT= to regular expression
...
******** TODO Add TITLE is =Footnotes= to regular expression
...
******** TODO Add =[:]ARCHIVE[:]= tag to regular expression 
...
******** TODO Fix empty tag match, i.e. =::=, in regular expression
