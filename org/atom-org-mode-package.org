...
# :var object_link_pattern=text-markup-js

#+NAME: gen-grammar-text-markup-cson
#+BEGIN_SRC ruby :var object_type="text-markup"  :var text_markers=org-emphasis-alist :results verbatim replace :noweb yes 
  text_markers.map{ |m|
    object_template = <<-EOT
  'object-#{object_type.downcase}-#{m[1].downcase}':
    'patterns':[
        {
          'match': #{%Q@<<text-markup-js>>@.inspect().gsub(/(\\)/,'\1\1').gsub(/\\{2}["]/,'\"').gsub(/(\\{2}){2}(\[)/,'\1\2')}
          'captures':
            '0':
              'name': 'markup.#{m[1].downcase}.#{object_type.downcase}.org-mode'
            '1':
              'name': 'punctuation.definition.#{m[1].downcase}.#{object_type.downcase}.org-mode'
            '3':
              'name': 'punctuation.definition.#{m[1].downcase}.#{object_type.downcase}.org-mode'
        }
    ]
...
#+NAME: grammar-text-markup-cson
#+RESULTS: gen-grammar-text-markup-cson
#+begin_example
'object-text-markup-bold':
  'patterns':[
      {
        'match': "(?:^|[ \\t('\"{-])([*])((?:[^ \\t\\n])(?:.+|.+[\\n].+)+(?:[^ \\t\\n])|(?:[^ \\t\\n]){1,2})([*])(?:[ \\t.,:!?;'\")}\\[-]|$)"
        'captures':
          '0':
            'name': 'markup.bold.text-markup.org-mode'
          '1':
            'name': 'punctuation.definition.bold.text-markup.org-mode'
          '3':
            'name': 'punctuation.definition.bold.text-markup.org-mode'
      }
  ]

'object-text-markup-italic':
  'patterns':[
      {
        'match': "(?:^|[ \\t('\"{-])([/])((?:[^ \\t\\n])(?:.+|.+[\\n].+)+(?:[^ \\t\\n])|(?:[^ \\t\\n]){1,2})([/])(?:[ \\t.,:!?;'\")}\\[-]|$)"
        'captures':
          '0':
            'name': 'markup.italic.text-markup.org-mode'
          '1':
            'name': 'punctuation.definition.italic.text-markup.org-mode'
          '3':
            'name': 'punctuation.definition.italic.text-markup.org-mode'
      }
  ]

'object-text-markup-underline':
  'patterns':[
      {
        'match': "(?:^|[ \\t('\"{-])([_])((?:[^ \\t\\n])(?:.+|.+[\\n].+)+(?:[^ \\t\\n])|(?:[^ \\t\\n]){1,2})([_])(?:[ \\t.,:!?;'\")}\\[-]|$)"
        'captures':
          '0':
            'name': 'markup.underline.text-markup.org-mode'
          '1':
            'name': 'punctuation.definition.underline.text-markup.org-mode'
          '3':
            'name': 'punctuation.definition.underline.text-markup.org-mode'
      }
  ]

'object-text-markup-verbatim':
  'patterns':[
      {
        'match': "(?:^|[ \\t('\"{-])([=])((?:[^ \\t\\n])(?:.+|.+[\\n].+)+(?:[^ \\t\\n])|(?:[^ \\t\\n]){1,2})([=])(?:[ \\t.,:!?;'\")}\\[-]|$)"
        'captures':
          '0':
            'name': 'markup.verbatim.text-markup.org-mode'
          '1':
            'name': 'punctuation.definition.verbatim.text-markup.org-mode'
          '3':
            'name': 'punctuation.definition.verbatim.text-markup.org-mode'
      }
  ]

'object-text-markup-code':
  'patterns':[
      {
        'match': "(?:^|[ \\t('\"{-])([~])((?:[^ \\t\\n])(?:.+|.+[\\n].+)+(?:[^ \\t\\n])|(?:[^ \\t\\n]){1,2})([~])(?:[ \\t.,:!?;'\")}\\[-]|$)"
        'captures':
          '0':
            'name': 'markup.code.text-markup.org-mode'
          '1':
            'name': 'punctuation.definition.code.text-markup.org-mode'
          '3':
            'name': 'punctuation.definition.code.text-markup.org-mode'
      }
  ]

'object-text-markup-strike-through':
  'patterns':[
      {
        'match': "(?:^|[ \\t('\"{-])([+])((?:[^ \\t\\n])(?:.+|.+[\\n].+)+(?:[^ \\t\\n])|(?:[^ \\t\\n]){1,2})([+])(?:[ \\t.,:!?;'\")}\\[-]|$)"
        'captures':
          '0':
            'name': 'markup.strike-through.text-markup.org-mode'
          '1':
            'name': 'punctuation.definition.strike-through.text-markup.org-mode'
          '3':
            'name': 'punctuation.definition.strike-through.text-markup.org-mode'
      }
  ]
