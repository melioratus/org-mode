...
:PROPERTIES:
:EXPORT_FILE_NAME: org-syntax-notes.org
:EXPORT_OPTIONS: f:t
:EXPORT_TITLE: Org Syntax Notes
:END:
...
#+BEGIN_SRC css :noweb yes :results verbatim replace :exports both :wrap EXAMPLE :exports results
...
#+BEGIN_SRC js :cmd "node" :var data=(org-sbe headline-test1) :results replace output :var pattern=headline-regex-js-elisp() :wrap "SRC js :eval never" :exports results 
...
#+CALL: elisp/display-this-here(data=org-syntax-stars-definition) :exports none
...
- *Export Blocks*
  ...
  - Code
    ...
    - grammar-export-blocks-cson
      ...
      #+BEGIN_SRC ruby :var data=elements-blocks-names :noweb yes :results verbatim :exports results 
        results = []
    ...
    - export-blocks-include-patterns-template-code
      ...
      #+BEGIN_SRC ruby  :var data=elements-blocks-names :exports results 
        include_patterns = []
...
#+BEGIN_SRC ruby :var object_link_type="radio-link" :var object_link_pattern=radio-links-js :exports results 
...
#+NAME: angle-links-js
#+BEGIN_SRC css :noweb yes :exports results 
  ([<]{2})<<PROTOCOL>>?<<PATH>>([>]{2})
#+END_SRC
...
#+BEGIN_SRC ruby :var object_link_type="angle-link" :var object_link_pattern=angle-links-js :exports results 
  object_link_template = <<-EOT
    'object-#{object_link_type.downcase}':
      'patterns':[
          {
...
#+BEGIN_SRC js :cmd "node" :var data="- <<target>>another item" :results replace output :var pattern=angle-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="http://www.astro.uva.nl/~dominik             on the web" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="put text before http://www.astro.uva.nl/~dominik?param1=123&param2=Hello%20World             on the web" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="put text before \nhttp://www.astro.uva.nl/~dominik             on the web" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="doi:10.1000/182                              DOI for an electronic resource" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="file:/home/dominik/images/jupiter.jpg        file, absolute path" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="/home/dominik/images/jupiter.jpg             same as above" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="file:papers/last.pdf                         file, relative path" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="./papers/last.pdf                            same as above" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="file:/ssh:myself@some.where:papers/last.pdf  file, path on remote machine" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="/ssh:myself@some.where:papers/last.pdf       same as above" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="file:sometextfile::NNN                       file, jump to line number" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="file:projects.org                            another Org file" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="file:projects.org::some words                text search in Org file(31)" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="file:projects.org::*task title               heading search in Org file(32)" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="docview:papers/last.pdf::NNN                 open in doc-view mode at page" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="id:B7423F4D-2E8A-471B-8810-C40F074717E9      Link to heading by ID" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="news:comp.emacs                              Usenet link" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="mailto:adent@galaxy.net                      Mail link" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="mhe:folder                                   MH-E folder link" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="mhe:folder#id                                MH-E message link" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="rmail:folder                                 RMAIL folder link" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="rmail:folder#id                              RMAIL message link" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="gnus:group                                   Gnus group link" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="gnus:group#id                                Gnus article link" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="bbdb:R.*Stallman                             BBDB link (with regexp)" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="irc:/irc.com/#emacs/bob                      IRC link" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="info:org#External links                      Info node or index link" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="shell:ls *.org                               A shell command" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="elisp:org-agenda                             Interactive Elisp command" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="elisp:(find-file-other-frame "Elisp.org")    Elisp form to evaluate" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="In all these simple examples, the common generic rc script will be deployed to =/etc/init.d/middleware=." :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="In this example, the path to the apache script is =/etc/init.d/httpd= and the service account is =apache=." :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="[[https://www.google.com]]" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="[[https://www.google.com][Google Search]]" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="[[file:links.org]]" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="[[file:links.org][This Code Example]]" :results replace output :var pattern=plain-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
********** zzz Empty Test Plain Link                      :noexport:
...
#+BEGIN_SRC ruby :var object_link_type="plain-link" :var object_link_pattern=plain-links-js  :exports results 
  object_link_template = <<-EOT
    'object-#{object_link_type.downcase}':
      'patterns':[
          {
...
#+BEGIN_SRC js :cmd "node" :var data="[[https://www.google.com]]" :results replace output :var pattern=regular-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="[[https://www.google.com][Google Search]]" :results replace output :var pattern=regular-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="[[file:links.org]]" :results replace output :var pattern=regular-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
#+BEGIN_SRC js :cmd "node" :var data="[[file:links.org][This Code Example]]" :results replace output :var pattern=regular-links-js() :wrap "SRC js :eval never" :exports results 
  let re = new RegExp(pattern);
  console.log(re)
  console.log(data.match(re))
#+END_SRC
...
********** zzz Empty Test Regular Link                    :noexport:
...
#+BEGIN_SRC ruby :var object_link_type="regular-link" :var object_link_pattern=regular-links-js :exports results 
  object_link_template = <<-EOT
    'object-#{object_link_type.downcase}':
      'patterns':[
          {
...
#+BEGIN_SRC ruby :var text_markers=org-emphasis-alist :results verbatim replace :noweb yes :var include_patterns=grammar-text-markup-include-objects() :var include_patterns_indent=26 :var exclude_patterns='() :exports both
  <<grammar-include-patterns-ruby>>
